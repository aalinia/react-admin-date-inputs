...
exports.KeyboardTimeInput = exports.KeyboardDateTimeInput = exports.KeyboardDateInput = exports.DateTimeInput = exports.TimeInput = exports.DateInput = exports.JalaliDateTimeInput = exports.JalaliDateInput = undefined;
...
var Picker = function Picker(_ref2) {
    var PickerComponent = _ref2.PickerComponent,
        ...
        _ref2$stringFormat = _ref2.stringFormat,
        stringFormat = _ref2$stringFormat === undefined ? 'ISO' : _ref2$stringFormat,
        rest = _objectWithoutProperties(_ref2, ['PickerComponent', 'format', 'label', 'options', 'source', 'resource', 'helperText', 'margin', 'onBlur', 'onChange', 'onFocus', 'parse', 'validate', 'variant', 'defaultValue', 'providerOptions', 'pickerVariant', 'stringFormat']);
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(PickerComponent, _extends({
            ...
            onBlur: function onBlur() {
                return input.onBlur(input.value ? stringFormat === 'ISO' ? new Date(input.value).toISOString() : new Date(input.value).toString() : null);
            }
        }))
    );
};
...
var JalaliDateInput = function JalaliDateInput(props) {
    return _react2.default.createElement(Picker, _extends({ PickerComponent: _pickers.DatePicker }, props));
};
var JalaliDateTimeInput = function JalaliDateTimeInput(props) {
    return _react2.default.createElement(Picker, _extends({ PickerComponent: _pickers.DateTimePicker }, props));
};
...
exports.JalaliDateInput = JalaliDateInput;
exports.JalaliDateTimeInput = JalaliDateTimeInput;
